...
public class BoardTest {
    ...
    @BeforeEach
    void setup() throws DepositHasReachedMaxLimit, DepositHasAnotherResource, AnotherDepositContainsThisResource, InvalidResource {
    ...
    void RemoveResourcesTestExceptions() throws DepositHasReachedMaxLimit, DepositHasAnotherResource, AnotherDepositContainsThisResource, InvalidResource {
        chosenResources.add(ResourceType.COIN);
